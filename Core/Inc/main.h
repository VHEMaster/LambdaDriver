...
/* Private defines -----------------------------------------------------------*/
#define MCU_O2_NRST_Pin GPIO_PIN_3
#define MCU_O2_NRST_GPIO_Port GPIOA
...
#define TIM15_CH1_O2_HEATER_Pin GPIO_PIN_14
#define TIM15_CH1_O2_HEATER_GPIO_Port GPIOB
